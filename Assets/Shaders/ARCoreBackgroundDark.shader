Shader "Custom/ARCoreBackgroundDark"
{
    Properties
    {
        _MainTex("Texture", 2D) = "white" {}
        _EnvironmentDepth("Texture", 2D) = "black" {}
        _TintColor ("Tint Color", color) = (0.13,0.05,0.16,1)
...
#extension GL_OES_EGL_image_external_essl3 : require
            ...
            void main()
            {
                ...
                vec4 tint = mix(vec4(1), _TintColor, _TintStrength);
				gl_FragColor = vec4(result, 1) * tint;
                gl_FragDepth = depth;
#endif // SHADER_API_GLES3
            }
